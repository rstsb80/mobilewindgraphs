...
<div id="header">
  ...
  <ul>
    ...
    <li><a href="<?=$_SERVER[PHP_SELF]?>?l=ecb">ecb</a></li>
  ...
  <ul>
    ...
    <li><a href="<?=$_SERVER[PHP_SELF]?>?l=246">246</a></li>
    <li><a href="<?=$_SERVER[PHP_SELF]?>?l=par2">par2</a></li>
    <li><a href="<?=$_SERVER[PHP_SELF]?>?l=sy">sy</a></li>
    <li><a href="<?=$_SERVER[PHP_SELF]?>?l=lospri">lospri</a></li>
  </ul>
  <br />
  <br />
  <ul>
    <li><a href="<?=$_SERVER[PHP_SELF]?>?l=acton">acton</a></li>
    <li><a href="<?=$_SERVER[PHP_SELF]?>?l=oakcreek">oakcreek</a></li>
    <li><a href="<?=$_SERVER[PHP_SELF]?>?l=ortega">ortega</a></li>
    <li><a href="<?=$_SERVER[PHP_SELF]?>?l=losbanos">losbanos</a></li>
    <li><a href="<?=$_SERVER[PHP_SELF]?>?l=losbanos2">losbanos2</a></li>
  </ul>
  </div>
</div>
<div id="content">
